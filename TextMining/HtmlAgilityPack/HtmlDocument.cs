...
namespace HtmlAgilityPack
{
    ...
    public class HtmlDocument : IXPathNavigable
    {
        ...
        /// <summary>
        /// Defines if HTML encoding in non-XML outputs should be normalized. Default is false.
        /// </summary>
        public bool OptionNormalizeHtmlEncoding;
        ...
        /// <summary>
        /// Applies HTML encoding to a specified string (can be already [partially] encoded). To be used for text between tags.
        /// </summary>
        /// <param name="html">The input string to encode. May not be null.</param>
        /// <returns>The encoded string.</returns>
        public static string EncodeHtmlText(string html)
        {
            if (html == null)
            {
            ...
            return html.Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("\xA0", "&nbsp;");
        }

        /// <summary>
        /// Applies HTML encoding to a specified string (can be already [partially] encoded). To be used for attribute values.
        /// </summary>
        /// <param name="html">The input string to encode. May not be null.</param>
        /// <returns>The encoded string.</returns>
        public static string EncodeHtmlAttrVal(string html)
        {
            return EncodeHtmlText(html).Replace("\"", "&quot;").Replace("'", "&#39;"/* = &apos; */);
        }

        /// <summary>
        /// Applies XML encoding to a specified string (can be already [partially] encoded). To be used for text between tags.
        /// </summary>
        /// <param name="xml">The input string to encode. May not be null.</param>
        /// <returns>The encoded string.</returns>
        public static string EncodeXmlText(string xml)
        {
            if (xml == null)
            {
            ...
            return sw.ToString().Replace("\xA0", "&#160;"/* = &nbsp; */);
        }

        /// <summary>
        /// Applies XML encoding to a specified string (can be already [partially] encoded). To be used for attribute values.
        /// </summary>
        /// <param name="xml">The input string to encode. May not be null.</param>
        /// <returns>The encoded string.</returns>
        public static string EncodeXmlAttrVal(string xml)
        {
            return EncodeXmlText(xml).Replace("\"", "&quot;"); 
        }

        private static Regex _illegalCDataChar = new Regex(@"[^\u0009\u000A\u000D\u0020-\uD7FF\uE000-\uFFFD]", RegexOptions.Compiled);

        /// <summary>
        /// Filters illegal characters from XML CDATA string. 
        /// </summary>
        /// <param name="xml">The input string to filter. May not be null.</param>
        /// <returns>A valid CDATA string.</returns>
        public static string RemoveIllegalCDataChars(string xml)
        {
            if (xml == null)
            {
                throw new ArgumentNullException("xml");
            }
            return _illegalCDataChar.Replace(xml, "?");
        }
