...
namespace HtmlAgilityPack
{
    ...
    public class HtmlAttribute : IComparable
    {
        ...
        private AttributeValueQuote _quoteType = AttributeValueQuote.DoubleQuote; // do not use SingleQuote when outputting XML!
        ...
        /// <summary>
        /// Specifies what type of quote the data should be wrapped in. Do not use SingleQuote when outputting XML!
        /// </summary>
