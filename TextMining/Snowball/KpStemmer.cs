...
namespace SF.Snowball.Ext
{
    ...
    public class KpStemmer : SnowballProgram, ISnowballStemmer
	{
		...
		{
			a0 = new Among[]{new Among("nde", - 1, 7), new Among("en", - 1, 6), new Among("s", - 1, 2), new Among("'s", 2, 1), new Among("es", 2, 4), new Among("ies", 4, 3), new Among("aus", 2, 5)};
			a1 = new Among[]{new Among("de", - 1, 5), new Among("ge", - 1, 2), new Among("ische", - 1, 4), new Among("je", - 1, 1), new Among("lijke", - 1, 3), new Among("le", - 1, 9), new Among("ene", - 1, 10), new Among("re", - 1, 8), new Among("se", - 1, 7), new Among("te", - 1, 6), new Among("ieve", - 1, 11)};
			a2 = new Among[]{new Among("heid", - 1, 3), new Among("fie", - 1, 7), new Among("gie", - 1, 8), new Among("atie", - 1, 1), new Among("isme", - 1, 5), new Among("ing", - 1, 5), new Among("arij", - 1, 6), new Among("erij", - 1, 5), new Among("sel", - 1, 3), new Among("rder", - 1, 4), new Among("ster", - 1, 3), new Among("iteit", - 1, 2), new Among("dst", - 1, 10), new Among("tst", - 1, 9)};
			a3 = new Among[]{new Among("end", - 1, 10), new Among("atief", - 1, 2), new Among("erig", - 1, 10), new Among("achtig", - 1, 9), new Among("ioneel", - 1, 1), new Among("baar", - 1, 3), new Among("laar", - 1, 5), new Among("naar", - 1, 4), new Among("raar", - 1, 6), new Among("eriger", - 1, 10), new Among("achtiger", - 1, 9), new Among("lijker", - 1, 8), new Among("tant", - 1, 7), new Among("erigst", - 1, 10), new Among("achtigst", - 1, 9), new Among("lijkst", - 1, 8)};
			a4 = new Among[]{new Among("ig", - 1, 1), new Among("iger", - 1, 1), new Among("igst", - 1, 1)};
			a5 = new Among[]{new Among("ft", - 1, 2), new Among("kt", - 1, 1), new Among("pt", - 1, 3)};
			a6 = new Among[]{new Among("bb", - 1, 1), new Among("cc", - 1, 2), new Among("dd", - 1, 3), new Among("ff", - 1, 4), new Among("gg", - 1, 5), new Among("hh", - 1, 6), new Among("jj", - 1, 7), new Among("kk", - 1, 8), new Among("ll", - 1, 9), new Among("mm", - 1, 10), new Among("nn", - 1, 11), new Among("pp", - 1, 12), new Among("qq", - 1, 13), new Among("rr", - 1, 14), new Among("ss", - 1, 15), new Among("tt", - 1, 16), new Among("v", - 1, 21), new Among("vv", 16, 17), new Among("ww", - 1, 18), new Among("xx", - 1, 19), new Among("z", - 1, 22), new Among("zz", 20, 20)};
			a7 = new Among[]{new Among("d", - 1, 1), new Among("t", - 1, 2)};
		}
