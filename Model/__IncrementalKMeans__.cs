...
{
    public class IncrementalKMeans<LblT> : IClustering<LblT, SparseVector<double>.ReadOnly> 
    {
        private int m_k;
        ...
        private int m_trials
            = 1;
        private ArrayList<Centroid<LblT>> m_centroids
            = null;
        ...
        // TODO: exceptions
        public void Update(int dequeue_n, IEnumerableList<SparseVector<double>.ReadOnly> add_list)
        {
            // update dataset
            // update centroids
            foreach (Centroid<LblT> centroid in m_centroids)
            {
                //centroid.__Update__(dequeue_n, dataset);
            }
            // ...
        }
